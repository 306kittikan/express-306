...
jest.mock("../controller/product.controller", () => ({
    getAll: jest.fn((req, res) => res.status(200).send({
        message: "OK",
        result: [{ id: 6604101306, name: "กิตติกานต์  เอียดใหญ่" }],
    })),
...
describe("Product Router", () => {
    ...
    it("should delete a product by ID", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).delete("/products/");
    ...
    it("รหัส ชื่อ-นามสกุล", () => __awaiter(void 0, void 0, void 0, function* () {
        const newProduct = { id: 6604101306, name: "กิตติกานต์  เอียดใหญ่", price: 20 };
